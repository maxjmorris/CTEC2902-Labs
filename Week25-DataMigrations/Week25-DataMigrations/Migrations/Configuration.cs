...
{
                new Product {ProductId = 1, Name = "IPhone 6", Colour = "Silver",
                    Price = 619.99m},
                new Product {ProductId = 2, Name = "Galaxy S5", Colour = "Black",
                    Price = 319.99m},
                new Product {ProductId = 3, Name = "Lumia 720", Colour = "Orange",
                    Price = 119.99m}
};
            ...
            Order order = new Order
            {
                ...
                OrderItems = new List<OrderItem> {
                    new OrderItem { OrderItemId = 1, OrderId = 1, ProductId = 1,
                        Quantity = 1},
                    new OrderItem { OrderItemId = 2, OrderId = 1, ProductId = 2,
                        Quantity = 2}
}
            };
